...
class DatabaseManager:
    ...
    def _initialize_database(self):
        ...
        self.logger.log_performance(
            "database_init", 0.0, success=True, metadata={"tables_created": True}
        )
    ...
    def load_project(self, project_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.log_error(
                e, operation="load_project", context={"project_id": project_id}
            )
            return None
    ...
    def get_recent_checkpoints(
        ...
        try:
            ...
            self.logger.log_error(
                e,
                operation="get_recent_checkpoints",
                context={"project_id": project_id},
            )
            return []
        ...
        try:
            with self._lock:
                ...
                self.logger.log_recovery_action(
                    f"Database backup created: {backup_name}", success=True
                )
                return str(backup_path)

        except Exception as e:
            self.logger.log_error(
                e, operation="create_backup", context={"backup_name": backup_name}
            )
            return None
    ...
    def set_setting(self, key: str, value: Any) -> bool:
        ...
        try:
            ...
            self.logger.log_error(e, operation="set_setting", context={"key": key})
            return False
    ...
    def start_session(self, session_id: str, project_id: str = None) -> bool:
        ...
        try:
            ...
            self.logger.log_error(
                e, operation="start_session", context={"session_id": session_id}
            )
            return False
        ...
        try:
            with self._lock:
                with self._get_connection() as conn:
                    ...
                    self.logger.log_recovery_action(
                        f"Cleaned up {deleted_count} old checkpoints", success=True
                    )
