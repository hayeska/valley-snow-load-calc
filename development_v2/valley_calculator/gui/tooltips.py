...
class TooltipManager:
    ...
    def add_tooltip(
        self, widget: tk.Widget, tooltip_id: str, custom_content: Optional[Dict] = None
    ):
        ...
        # Bind events
        widget.bind(
            "<Enter>", lambda e: self._schedule_show_tooltip(widget, tooltip_id)
        )
    ...
    def show_help_tooltip(self, widget: tk.Widget, help_text: str):
        ...
        self.tooltip_content[temp_id] = {"title": "Help", "content": help_text}
...
def add_tooltip(
    widget: tk.Widget, tooltip_id: str, custom_content: Optional[Dict] = None
):
